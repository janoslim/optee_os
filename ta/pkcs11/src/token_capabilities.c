...
static const struct pkcs11_mechachism_modes pkcs11_modes[] = {
	...
	MECHANISM(PKCS11_CKM_AES_CCM, CKFM_CIPHER_WRAP, ANY_PART),
	MECHANISM(PKCS11_CKM_AES_GMAC, CKFM_AUTH_NO_RECOVER |
		  PKCS11_CKFM_DERIVE, ANY_PART),
	...
	MECHANISM(PKCS11_CKM_AES_XCBC_MAC, CKFM_AUTH_NO_RECOVER, ANY_PART),
	/* EC */
	...
	MECHANISM(PKCS11_CKM_SHA224_RSA_PKCS_PSS, CKFM_AUTH_NO_RECOVER,
		  ANY_PART),
	MECHANISM(PKCS11_CKM_RSA_AES_KEY_WRAP, CKFM_WRAP_UNWRAP, ANY_PART),
	/* Digests */
